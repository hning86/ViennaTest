...
root_run = Run.start_logging(workspace = ws, run_history_name = run_history_name)
...
for r in tqdm(root_run.get_children()):
    child_runs[r.id] = r
...
aciconfig = AciCompute.deploy_configuration(cpu_cores = 1, 
                                            memory_gb = 1, 
                                            tags = ['e2e-01'], 
